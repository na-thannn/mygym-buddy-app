  ...
  head: () => ({
    meta: [
      { title: "HL Fitness 303 Le Thanh Nghi — AI powered training platform" },
      {
        name: "description",
        content:
          "HL Fitness Da Nang community — track InBody, workouts, nutrition, AI Coach, and real trainers.",
      },
    ],
  }),
  component: Landing,
...
function Landing() {
  const features = [
    {
      ...
      desc: "Upload results and see progress charts over time.",
    },
    { icon: Dumbbell, title: "Workout Log", desc: "Record sets, reps, and loads with weekly PRs." },
    {
      icon: Apple,
      title: "Nutrition Log",
      desc: "Track meals, calories, and macros with clarity.",
    },
    {
      icon: MessageCircle,
      title: "AI Coach",
      desc: "Ask training questions and generate plans. Real coaches on call.",
    },
    {
      icon: LineChart,
      title: "Progress Analytics",
      desc: "Weight, fat, and muscle trends that keep you on track.",
    },
    {
      icon: Activity,
      title: "Gym Community",
      desc: "Share wins, support others, and train as a team.",
    },
  ];
  const programs = [
    {
      title: "Strength Build",
      desc: "Lean muscle with controlled progression.",
      icon: Dumbbell,
      img: "https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?w=800&q=80",
    },
    {
      title: "Fat Loss",
      desc: "Smart cardio plus HIIT for lasting shape.",
      icon: Flame,
      img: "https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&q=80",
    },
    {
      title: "Mobility Reset",
      desc: "Recover better and move without limits.",
      icon: HeartPulse,
      img: "https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=800&q=80",
    },
    {
      title: "Power Endurance",
      desc: "Raise your ceiling for long sessions.",
      icon: Timer,
  ...
  const coaches = [
    {
      name: "Blake Hunter",
      role: "Strength Coach",
      img: "https://images.unsplash.com/photo-1563122870-6b0b48a0af09?w=400&q=80",
    },
    {
      name: "Liam CrossFit",
      role: "Conditioning",
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#1b1f14,_#0f120c_55%,_#090b07_100%)] text-slate-100">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Button
              ...
              variant="ghost"
              size="sm"
              className="text-slate-100 hover:text-slate-900 hover:bg-yellow-300"
            >
      ...
      <section className="max-w-6xl mx-auto px-4 py-14 md:pt-9 md:pb-24 grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
        <div>
          ...
          <p className="mt-6 text-base md:text-lg text-slate-300 max-w-xl animate-fade-up stagger-1">
            Track workouts, log meals, analyze your InBody results, and chat with your AI Coach —
            everything you need to crush your goals in one app.
          </p>
          <div className="mt-8 flex flex-wrap items-center gap-3 animate-fade-up stagger-2">
            <Button
              asChild
              size="lg"
              className="bg-yellow-400 text-yellow-950 hover:bg-yellow-300 relative group overflow-hidden"
            >
              <Link to="/get-started">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-white/20 bg-white/5 text-slate-100 hover:border-yellow-200 hover:bg-yellow-300 hover:text-yellow-950 hover:shadow-[0_0_18px_rgba(250,204,21,0.35)]"
            >
              <Link to="/auth" search={{ mode: "login", redirect: "/feed", email: "" }}>
        ...
        <div className="relative animate-fade-up stagger-2 hidden md:block">
          ...
          <div className="relative rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_top,_#1a2011,_#0c0f0a_60%)] p-2 shadow-2xl overflow-hidden aspect-[4/5] transform perspective-[1000px] rotate-y-[-10deg] rotate-x-[5deg]">
            ...
            {/* Mock App Header */}
            <div className="mx-2 mt-2 flex items-center justify-between rounded-2xl border border-white/10 bg-black/50 p-4">
              ...
              <div className="size-6 bg-white/10 rounded-full flex items-center justify-center text-xs">
                V
              </div>
            </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                  ...
                  <div className="text-lg font-bold">
                    76.2 <span className="text-xs text-slate-500 font-normal">kg</span>
                  </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-3">
                  ...
                  <div className="text-lg font-bold">
                    2,450 <span className="text-xs text-slate-500 font-normal">kcal</span>
                  </div>
              ...
              <div className="h-20 w-full flex items-end gap-1 px-2 opacity-50">
                {[40, 60, 45, 80, 50, 90, 75].map((h, i) => (
                  <div
                    key={i}
                    className="flex-1 bg-yellow-400/50 rounded-t-sm"
                    style={{ height: `${h}%` }}
                  ></div>
                ))}
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-slate-400 text-lg">
              A seamless loop between putting in the work and seeing the results.
            </p>
          </div>
            ...
            {[
              {
                no: "01",
                title: "Assessment",
                desc: "Start with an InBody scan. Upload your stats to set a baseline.",
              },
              {
                no: "02",
                title: "Plan",
                desc: "Our AI Coach builds a personalized workout & nutrition protocol.",
              },
              {
                no: "03",
                title: "Action",
                desc: "Log your daily meals and track your sets/reps in the gym.",
              },
              {
                no: "04",
                title: "Progress",
                desc: "Analyze trends, adjust macros, and celebrate your wins.",
              },
            ].map((step) => (
              <div key={step.no} className="relative group">
                <div className="text-6xl font-black text-white/5 absolute -top-6 -left-2 group-hover:text-yellow-400/10 transition-colors">
                  {step.no}
                </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {programs.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="group relative rounded-2xl border border-white/10 bg-black/40 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-yellow-500/10 h-36"
                >
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {coaches.map((coach) => (
            <div
              key={coach.name}
              className="group relative rounded-2xl border border-white/10 bg-black/40 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-yellow-500/10 h-72"
            >
              <div className="absolute inset-0 z-0">
                <img
                  src={coach.img}
              ...
              <div className="relative z-10 p-6 h-full flex flex-col justify-end">
                ...
                <div className="text-sm text-yellow-400 font-medium tracking-wide mb-2">
                  {coach.role}
                </div>
                <div className="text-xs text-slate-300">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        <div className="rounded-[28px] border border-white/10 bg-gradient-to-r from-yellow-400/20 via-white/5 to-transparent p-8 md:p-12">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              <div className="text-yellow-300 text-sm uppercase tracking-[0.2em]">
                Success Stories
              </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-2">
            {testimonials.map((item) => (
              <div
                key={item.name}
                className="rounded-2xl border border-white/10 bg-black/40 p-6 transition-all duration-300 hover:-translate-y-1 hover:bg-white/5"
              >
