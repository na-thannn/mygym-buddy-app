      ...
      >
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1">
            ...
            <Input
              type="number"
              value={f.totalSessions}
              onChange={(e) => setF({ ...f, totalSessions: e.target.value })}
            />
          </div>
          <div className="space-y-1">
            ...
            <Input
              type="number"
              value={f.streakDays}
              onChange={(e) => setF({ ...f, streakDays: e.target.value })}
            />
          </div>
          <div className="space-y-1">
            ...
            <Input
              ...
              step="0.1"
              value={f.totalVolume}
              onChange={(e) => setF({ ...f, totalVolume: e.target.value })}
            />
          </div>
        </div>
        <div className="space-y-1">
        ...
        {rows.map((r) => (
          ...
          >
            ...
            <div className="text-xs text-slate-400 mt-0.5">
              {r.totalSessions ?? 0} sessions • streak {r.streakDays ?? 0} days • volume{" "}
              {r.totalVolume ?? 0} kg
            </div>
