  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-6">
      <PageHeader
        ...
        subtitle="Ask AI Coach to generate a plan in AI Coach chat and it will appear here."
      />
      <div className="space-y-2">
        {rows.length === 0 && (
          <div className="text-sm text-slate-400 text-center py-10">
            No plans yet. Open AI Coach chat and say: "Build me a 4-day workout plan".
          </div>
        )}
        {rows.map((r) => {
          ...
          return (
            <div
              key={r.id}
              className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur transition-all duration-300 hover:-translate-y-0.5 hover:bg-white/5"
            >
