  ...
  const [meals, setMeals] = useState<Meal[]>([
    {
      ...
      type: "Breakfast",
      icon: "🍳",
      desc: "Oatmeal with whey protein and berries",
      cals: 450,
    },
    {
      id: 2,
      type: "Lunch",
      icon: "🥗",
      desc: "Grilled chicken breast with quinoa and broccoli",
      cals: 650,
    },
  ]);
  ...
  return (
    <div className="mx-auto max-w-4xl p-4 md:p-8 pb-24 md:pb-8">
          ...
          <DialogContent className="sm:max-w-[425px] bg-[#0a0c08] border-white/10 text-slate-200">
            <form onSubmit={handleLogMeal}>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  <Label htmlFor="cals" className="text-right text-slate-300">
                    Calories
                  </Label>
                  <Input
                    id="cals"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 animate-fade-up">
        <div className="rounded-2xl border border-white/10 bg-black/40 backdrop-blur p-4 flex flex-col items-center justify-center text-center">
          ...
          <div className="text-2xl font-bold text-slate-100">
            {totalCals} <span className="text-sm font-normal text-slate-400">/ 2450</span>
          </div>
      ...
      <div className="mt-8">
        <Button
          variant="outline"
          className="w-full border-white/10 text-slate-300 hover:text-yellow-300 hover:border-yellow-500/30"
        >
